...
import type { TrPayload } from './tr.types';

const TR_PAYLOAD_KEYS: (keyof TrPayload)[] = [
  'objectDescription',
  'contractingPurpose',
 ...
 */
export function normalizeTrPayload(
 ...
 */
export function mapTrPayloadToContext(input: ModuleInputContract): Record<string, unknown> {
  return {
