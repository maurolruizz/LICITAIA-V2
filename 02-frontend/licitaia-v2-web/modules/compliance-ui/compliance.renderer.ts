...
function verdictClass(verdict: ComplianceReport['verdict']): string {
  if (verdict === 'APPROVED') return 'approved';
  if (verdict === 'APPROVED_WITH_WARNINGS') return 'approved-warning';
 ...
 */
export function renderComplianceReportHtml(report: ComplianceReport): string {
