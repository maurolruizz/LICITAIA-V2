...
exports.executeDfdModule = executeDfdModule;
...
const dfd_mappers_1 = require("./dfd.mappers");
const dfd_validators_1 = require("./dfd.validators");
...
const dfd_events_1 = require("./dfd.events");
async function executeDfdModule(input) {
    const processId = input.context?.processId;
    const normalizedPayload = (0, dfd_mappers_1.normalizeDfdPayload)(input.payload ?? {});
    ...
    const validation = (0, dfd_validators_1.validateDfdInput)(normalizedPayload);
    const events = [
        (0, dfd_events_1.buildDfdStartedEvent)(processId),
    ];
    if (extractedStructure.structureType === 'lot') {
        events.push((0, event_builders_1.buildObjectStructureLotDetectedEvent)(module_id_enum_1.ModuleId.DFD, objectStructureMeta, processId));
    }
    if (extractedCalculationMemory.count > 0) {
        events.push((0, event_builders_1.buildCalculationMemoryDetectedEvent)(module_id_enum_1.ModuleId.DFD, {
    ...
    if (extractedAdministrativeJustification.count > 0) {
        events.push((0, event_builders_1.buildAdministrativeJustificationDetectedEvent)(module_id_enum_1.ModuleId.DFD, {
    ...
    if (coherenceResult.hasCoherenceIssues) {
        events.push((0, event_builders_1.buildAdministrativeCoherenceIssuesDetectedEvent)(module_id_enum_1.ModuleId.DFD, coherenceResult, processId));
    }
    else {
        events.push((0, event_builders_1.buildAdministrativeCoherenceValidEvent)(module_id_enum_1.ModuleId.DFD, processId));
    }
    if (extractedAdministrativeNeed.count > 0) {
        events.push((0, event_builders_1.buildAdministrativeNeedDetectedEvent)(module_id_enum_1.ModuleId.DFD, {
    ...
    if (extractedProcurementStrategy.count > 0) {
        events.push((0, event_builders_1.buildProcurementStrategyDetectedEvent)(module_id_enum_1.ModuleId.DFD, {
    ...
    if (documentConsistencyResult.hasIssues) {
        events.push((0, event_builders_1.buildAdministrativeDocumentConsistencyIssuesDetectedEvent)(module_id_enum_1.ModuleId.DFD, documentConsistencyResult, processId));
    }
    else {
        events.push((0, event_builders_1.buildAdministrativeDocumentConsistencyValidEvent)(module_id_enum_1.ModuleId.DFD, processId));
    }
    const decisionTraces = (0, administrative_decision_trace_engine_1.executeAdministrativeDecisionTraceEngine)({
        structure: { ...extractedStructure, moduleId: module_id_enum_1.ModuleId.DFD },
    ...
    events.push((0, event_builders_1.buildAdministrativeDecisionTraceGeneratedEvent)(module_id_enum_1.ModuleId.DFD, {
    ...
    if (decisionTraceMeta.decisionTrace.hasIncomplete) {
        events.push((0, event_builders_1.buildAdministrativeDecisionTraceIncompleteEvent)(module_id_enum_1.ModuleId.DFD, {
            totalTraces: decisionTraceMeta.decisionTrace.totalTraces,
            hasIncomplete: true,
        }, processId));
    }
    ...
    events.push((0, event_builders_1.buildAdministrativeDecisionExplanationGeneratedEvent)(module_id_enum_1.ModuleId.DFD, {
    ...
    if (decisionExplanationMeta.decisionExplanation.hasIncomplete) {
        events.push((0, event_builders_1.buildAdministrativeDecisionExplanationIncompleteEvent)(module_id_enum_1.ModuleId.DFD, {
            totalExplanations: decisionExplanationMeta.decisionExplanation.totalExplanations,
            hasIncomplete: true,
        }, processId));
    }
    ...
    events.push((0, event_builders_1.buildAdministrativeDocumentGeneratedEvent)(module_id_enum_1.ModuleId.DFD, {
    ...
    if (documentMeta.document.hasIncomplete) {
        events.push((0, event_builders_1.buildAdministrativeDocumentIncompleteEvent)(module_id_enum_1.ModuleId.DFD, {
            totalDocuments: documentMeta.document.totalDocuments,
            hasIncomplete: true,
        }, processId));
    }
    ...
    if (validation.hasBlocking) {
        events.push((0, dfd_events_1.buildDfdBlockedEvent)(validation.items.map((i) => i.message).join('; ') ?? 'Campos obrigatórios ausentes ou inválidos', { processId, payload: { validationCodes: validation.items.map((i) => i.code) } }));
        ...
        result = (0, module_result_factory_1.createBlockedResult)(validation.items.map((i) => i.message).join('; ') ?? 'Validação DFD bloqueou', validation.items.map((i) => i.code));
        shouldHalt = true;
    }
    else if (!validation.valid) {
        events.push((0, dfd_events_1.buildDfdBlockedEvent)(validation.items.map((i) => i.message).join('; '), { processId }));
        decisionMetadata = (0, decision_metadata_factory_1.createDecisionMetadata)(decision_origin_enum_1.DecisionOrigin.MODULE, {
            moduleId: module_id_enum_1.ModuleId.DFD,
        ...
        events.push((0, dfd_events_1.buildDfdValidatedEvent)(processId), (0, dfd_events_1.buildDfdCompletedEvent)(processId));
        decisionMetadata = (0, decision_metadata_factory_1.createDecisionMetadata)(decision_origin_enum_1.DecisionOrigin.MODULE, {
            moduleId: module_id_enum_1.ModuleId.DFD,
            ruleId: 'DFD_APPROVED',
        ...
        result = (0, module_result_factory_1.createSuccessResult)({ ...normalizedPayload, _validatedByModule: 'DFD' }, 'DFD validado');
        shouldHalt = false;
    }
    return {
        moduleId: module_id_enum_1.ModuleId.DFD,
