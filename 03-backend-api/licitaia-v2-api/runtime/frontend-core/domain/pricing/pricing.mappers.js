...
exports.normalizePricingPayload = normalizePricingPayload;
exports.mapPricingPayloadToContext = mapPricingPayloadToContext;
 ...
 */
function mapPricingPayloadToContext(input) {
    return {
