...
exports.executeEtpModule = executeEtpModule;
...
const etp_mappers_1 = require("./etp.mappers");
const etp_validators_1 = require("./etp.validators");
const etp_events_1 = require("./etp.events");
...
async function executeEtpModule(input) {
    const processId = input.context?.processId;
    const normalizedPayload = (0, etp_mappers_1.normalizeEtpPayload)(input.payload ?? {});
    ...
    const validation = (0, etp_validators_1.validateEtpInput)(normalizedPayload);
    const events = [
        (0, etp_events_1.buildEtpStartedEvent)(processId),
    ];
    if (extractedStructure.structureType === 'lot') {
        events.push((0, event_builders_1.buildObjectStructureLotDetectedEvent)(module_id_enum_1.ModuleId.ETP, objectStructureMeta, processId));
    }
    if (extractedCalculationMemory.count > 0) {
        events.push((0, event_builders_1.buildCalculationMemoryDetectedEvent)(module_id_enum_1.ModuleId.ETP, {
    ...
    if (extractedAdministrativeJustification.count > 0) {
        events.push((0, event_builders_1.buildAdministrativeJustificationDetectedEvent)(module_id_enum_1.ModuleId.ETP, {
    ...
    if (coherenceResult.hasCoherenceIssues) {
        events.push((0, event_builders_1.buildAdministrativeCoherenceIssuesDetectedEvent)(module_id_enum_1.ModuleId.ETP, coherenceResult, processId));
    }
    else {
        events.push((0, event_builders_1.buildAdministrativeCoherenceValidEvent)(module_id_enum_1.ModuleId.ETP, processId));
    }
    if (extractedAdministrativeNeed.count > 0) {
        events.push((0, event_builders_1.buildAdministrativeNeedDetectedEvent)(module_id_enum_1.ModuleId.ETP, {
    ...
    if (extractedProcurementStrategy.count > 0) {
        events.push((0, event_builders_1.buildProcurementStrategyDetectedEvent)(module_id_enum_1.ModuleId.ETP, {
    ...
    if (documentConsistencyResult.hasIssues) {
        events.push((0, event_builders_1.buildAdministrativeDocumentConsistencyIssuesDetectedEvent)(module_id_enum_1.ModuleId.ETP, documentConsistencyResult, processId));
    }
    else {
        events.push((0, event_builders_1.buildAdministrativeDocumentConsistencyValidEvent)(module_id_enum_1.ModuleId.ETP, processId));
    }
    const decisionTraces = (0, administrative_decision_trace_engine_1.executeAdministrativeDecisionTraceEngine)({
        structure: { ...extractedStructure, moduleId: module_id_enum_1.ModuleId.ETP },
    ...
    events.push((0, event_builders_1.buildAdministrativeDecisionTraceGeneratedEvent)(module_id_enum_1.ModuleId.ETP, {
    ...
    if (decisionTraceMeta.decisionTrace.hasIncomplete) {
        events.push((0, event_builders_1.buildAdministrativeDecisionTraceIncompleteEvent)(module_id_enum_1.ModuleId.ETP, {
            totalTraces: decisionTraceMeta.decisionTrace.totalTraces,
            hasIncomplete: true,
        }, processId));
    }
    ...
    events.push((0, event_builders_1.buildAdministrativeDecisionExplanationGeneratedEvent)(module_id_enum_1.ModuleId.ETP, {
    ...
    if (decisionExplanationMeta.decisionExplanation.hasIncomplete) {
        events.push((0, event_builders_1.buildAdministrativeDecisionExplanationIncompleteEvent)(module_id_enum_1.ModuleId.ETP, {
            totalExplanations: decisionExplanationMeta.decisionExplanation.totalExplanations,
            hasIncomplete: true,
        }, processId));
    }
    ...
    events.push((0, event_builders_1.buildAdministrativeDocumentGeneratedEvent)(module_id_enum_1.ModuleId.ETP, {
    ...
    if (documentMeta.document.hasIncomplete) {
        events.push((0, event_builders_1.buildAdministrativeDocumentIncompleteEvent)(module_id_enum_1.ModuleId.ETP, {
            totalDocuments: documentMeta.document.totalDocuments,
            hasIncomplete: true,
        }, processId));
    }
    ...
    if (validation.hasBlocking) {
        events.push((0, etp_events_1.buildEtpBlockedEvent)(validation.items.map((i) => i.message).join('; ') ?? 'Campos obrigatórios ausentes ou inválidos', { processId, payload: { validationCodes: validation.items.map((i) => i.code) } }));
        (0, module_validation_events_helper_1.appendCommonInvalidationEvents)({
            moduleId: module_id_enum_1.ModuleId.ETP,
        ...
        result = (0, module_result_factory_1.createBlockedResult)(validation.items.map((i) => i.message).join('; ') ?? 'Validação ETP bloqueou', validation.items.map((i) => i.code));
        shouldHalt = true;
    }
    else if (!validation.valid) {
        events.push((0, etp_events_1.buildEtpBlockedEvent)(validation.items.map((i) => i.message).join('; '), { processId }));
        decisionMetadata = (0, decision_metadata_factory_1.createDecisionMetadata)(decision_origin_enum_1.DecisionOrigin.MODULE, {
            moduleId: module_id_enum_1.ModuleId.ETP,
        ...
        events.push((0, etp_events_1.buildEtpValidatedEvent)(processId), (0, etp_events_1.buildEtpCompletedEvent)(processId));
        decisionMetadata = (0, decision_metadata_factory_1.createDecisionMetadata)(decision_origin_enum_1.DecisionOrigin.MODULE, {
            moduleId: module_id_enum_1.ModuleId.ETP,
            ruleId: 'ETP_APPROVED',
        ...
        result = (0, module_result_factory_1.createSuccessResult)({ ...normalizedPayload, _validatedByModule: 'ETP' }, 'ETP validado');
        shouldHalt = false;
    }
    return {
        moduleId: module_id_enum_1.ModuleId.ETP,
